...
//! "leave the old title alone" or "clear the title Millie last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Millie manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Millie started managing the title.
