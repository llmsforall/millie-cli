...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let _ = self.update_action;
        let update_instruction = line![
            "Update by re-running ",
            "install.sh".cyan(),
            " from a newer Millie bundle."
        ];
        ...
        let content = text![
            ...
            "",
            "See ",
            "https://llmsforall.com".cyan().underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        vec![
            ...
            Line::from("Update by re-running install.sh from a newer Millie bundle."),
            Line::from(""),
            Line::from("See https://llmsforall.com"),
        ]
    }
