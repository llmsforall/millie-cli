...
pub(crate) fn migration_copy_for_models(
    ...
    let heading_text = Span::from(format!(
        "Millie just got an upgrade. Introducing {target_display_name}."
    ))
    .bold();
...
impl ModelMigrationScreen {
    ...
    fn render_menu(&self, column: &mut ColumnRenderable) {
        column.push(Line::from(""));
        column.push(
            Paragraph::new("Choose how you'd like Millie to proceed.")
                .wrap(Wrap { trim: false })
                .inset(Insets::tlbr(
                    /*top*/ 0, /*left*/ 2, /*bottom*/ 0, /*right*/ 0,
                )),
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                /*model_link*/ None,
                Some(
                    "Upgrade for the latest and greatest agentic coding model."
                        .to_string(),
                ),
                /*migration_markdown*/ None,
                "millie-35B-A3B-7GB".to_string(),
                Some("Millie-optimized flagship for deep and fast reasoning.".to_string()),
                /*can_opt_out*/ true,
            ),
        );
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "millie-35B-A3B-11GB",
                "millie-35B-A3B-7GB",
                Some("https://llmsforall.com".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "millie-35B-A3B-7GB".to_string(),
    ...
    fn prompt_snapshot_gpt5_codex_mini() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                /*migration_markdown*/ None,
                "millie-35B-A3B-7GB".to_string(),
                Some("Smaller and faster, with lower memory use.".to_string()),
                /*can_opt_out*/ false,
            ),
        );
        {
