...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $MILLIE_HOME/config.toml. This layer is special
    ...
    /// Path to a .millie/ folder within a project. There could be multiple of
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.millie, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
