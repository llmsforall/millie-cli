...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Millie is currently considering and their roots.
    List,
...
#[command(
    ...
    after_help = "Examples:\n  millie-cli plugin marketplace add ./path/to/marketplace\n  millie-cli plugin marketplace add owner/repo --ref main\n  millie-cli plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[command(
    ...
    after_help = "Examples:\n  millie-cli plugin marketplace upgrade\n  millie-cli plugin marketplace upgrade debug"
)]
...
#[command(
    ...
    after_help = "Example:\n  millie-cli plugin marketplace remove debug"
)]
...
async fn run_add(args: AddMarketplaceArgs) -> Result<()> {
    ...
    let codex_home = find_codex_home().context("failed to resolve MILLIE_HOME")?;
