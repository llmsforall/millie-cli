...
#[command(
    ...
    after_help = "Examples:\n  millie-cli plugin add sample@debug\n  millie-cli plugin add sample --marketplace debug"
)]
...
#[command(
    ...
    after_help = "Examples:\n  millie-cli plugin list\n  millie-cli plugin list --marketplace debug"
)]
...
#[command(
    ...
    after_help = "Examples:\n  millie-cli plugin remove sample@debug\n  millie-cli plugin remove sample --marketplace debug"
)]
