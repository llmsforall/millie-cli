...
pub trait ModelProvider: fmt::Debug + Send + Sync {
    ...
    /// `system_prompt` is the served system prompt text, resolved at startup.
    fn models_manager(
        &self,
        codex_home: PathBuf,
...
mod tests {
    ...
    use codex_models_manager::system_prompt::resolve_system_prompt_for_tests;
    ...
    fn test_system_prompt() -> String {
        resolve_system_prompt_for_tests(&test_codex_home()).text
    }
