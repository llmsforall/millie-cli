...
//!
//! The history is stored at `~/.millie/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.millie`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.millie/history.jsonl` and ensure the parent directory exists.
