...
pub const REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR: &str = "MILLIE_REFRESH_TOKEN_URL_OVERRIDE";
pub const REVOKE_TOKEN_URL_OVERRIDE_ENV_VAR: &str = "MILLIE_REVOKE_TOKEN_URL_OVERRIDE";
...
pub const CODEX_API_KEY_ENV_VAR: &str = "MILLIE_API_KEY";
pub const CODEX_ACCESS_TOKEN_ENV_VAR: &str = "MILLIE_ACCESS_TOKEN";
