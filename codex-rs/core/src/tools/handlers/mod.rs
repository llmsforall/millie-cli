...
mod str_replace;
mod str_replace_correct;
pub(crate) mod str_replace_spec;
mod test_sync;
...
pub use str_replace::CreateFileHandler;
pub use str_replace::DeleteFileHandler;
pub use str_replace::StrReplaceHandler;
