...
impl CodexThread {
    ...
    pub async fn model_broker_complete(
        &self,
        request: crate::model_broker::ModelBrokerRequest,
    ) -> CodexResult<crate::model_broker::ModelBrokerResponse> {
        self.codex.session.model_broker_complete(request).await
    }
