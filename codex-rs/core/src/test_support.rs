...
pub fn models_manager_with_provider(
    ...
    let system_prompt =
        codex_models_manager::system_prompt::resolve_system_prompt_for_tests(&codex_home).text;
    provider.models_manager(codex_home, /*config_model_catalog*/ None, system_prompt)
}
