...
const TRACE_DISABLED_MESSAGE: &str =
    "Not enabled - enable tracing in $MILLIE_HOME/config.toml to get a trace URL!";
...
struct Cli {
    ...
    #[arg(long, env = "MILLIE_BIN", global = true)]
    ...
    /// `ws://127.0.0.1:4222`.
    #[arg(long, env = "MILLIE_APP_SERVER_URL", global = true)]
    url: Option<String>,
...
enum CliCommand {
    ...
    LiveElicitationTimeoutPause {
        ...
        #[arg(long, env = "MILLIE_E2E_MODEL", default_value = "gpt-5")]
        model: String,
