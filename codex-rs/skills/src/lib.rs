...
/// Returns the on-disk cache location for embedded system skills from an absolute MILLIE_HOME.
...
/// Installs embedded system skills into `MILLIE_HOME/skills/.system`.
///
