...
- This repo’s scaffold writes `.millie-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Millie renders plugins.
