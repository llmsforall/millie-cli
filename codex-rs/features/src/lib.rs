...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Deprecated,
        // Millie sandboxes Linux with the kernel-native Landlock + seccomp
        // path and does not bundle bubblewrap (no external dependencies).
        // Upstream deprecated this in favor of bwrap; we keep it as the
        // default deliberately. See bwrap/build.rs (MILLIE_SKIP_BWRAP_BUILD).
        default_enabled: true,
    },
    FeatureSpec {
