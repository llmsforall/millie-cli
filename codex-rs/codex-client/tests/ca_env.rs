...
const CODEX_CA_CERT_ENV: &str = "MILLIE_CA_CERTIFICATE";
const PROBE_PROXY_ENV: &str = "MILLIE_CUSTOM_CA_PROBE_PROXY";
const PROBE_TLS13_ENV: &str = "MILLIE_CUSTOM_CA_PROBE_TLS13";
const PROBE_URL_ENV: &str = "MILLIE_CUSTOM_CA_PROBE_URL";
...
fn rejects_empty_pem_file_with_hint() {
    ...
    assert!(stderr.contains("MILLIE_CA_CERTIFICATE"));
