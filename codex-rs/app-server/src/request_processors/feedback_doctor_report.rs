...
//! the configured Millie executable as a subprocess, accepts only valid JSON from
...
///
/// Failure to spawn Millie, finish before the timeout, or parse JSON means the
