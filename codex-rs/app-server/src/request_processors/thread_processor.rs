...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_extension_tools_only) = request.extension_tools_only
        && requested_extension_tools_only != config_snapshot.extension_tools_only
    {
        mismatch_details.push(format!(
            "extension_tools_only requested={requested_extension_tools_only} active={}",
            config_snapshot.extension_tools_only
        ));
    }
...
impl ThreadRequestProcessor {
    ...
    fn build_thread_config_overrides(
        ...
        extension_tools_only: Option<bool>,
    ) -> ConfigOverrides {
        ConfigOverrides {
            model,
            model_provider,
