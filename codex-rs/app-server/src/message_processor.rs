...
use crate::request_processors::ModelBrokerRequestProcessor;
...
pub(crate) struct MessageProcessor {
    ...
    model_broker_processor: ModelBrokerRequestProcessor,
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let model_broker_processor = ModelBrokerRequestProcessor::new(Arc::clone(&thread_manager));
    ...
    async fn handle_initialized_client_request(
        ...
        let result: Result<Option<ClientResponsePayload>, JSONRPCErrorError> = match codex_request {
            ...
            ClientRequest::ModelProviderCapabilitiesRead { params: _, .. } => self
                ...
                .await
                .map(|response| Some(response.into())),
            ClientRequest::ModelBrokerComplete { params, .. } => self
                .model_broker_processor
                .complete(params)
                .await
                .map(|response| Some(response.into())),
